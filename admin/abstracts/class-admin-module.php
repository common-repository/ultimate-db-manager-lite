<?php
/**
 * Ultimate_DB_Manager_Admin_Module Class
 *
 * @since  1.0.0
...
if ( ! class_exists( 'Ultimate_DB_Manager_Admin_Module' ) ) :

abstract class Ultimate_DB_Manager_Admin_Module {
	...
	/**
	 * Ultimate_DB_Manager_Admin_Module constructor.
	 *
	 * @since 1.0
	 */
	...
	public function admin_submenu_file( $submenu_file, $parent_file ) {
		...
		if ( 'ultimate_db_manager' !== $parent_file ) {
			return $submenu_file;
		}
